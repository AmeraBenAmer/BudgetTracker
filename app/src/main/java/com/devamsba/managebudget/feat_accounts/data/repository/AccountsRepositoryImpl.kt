...
class AccountsRepositoryImpl @Inject constructor(
    ...
    override suspend fun insertAll(accounts: ArrayList<AccountsEntity>) =
        db.accountsDao().insertAll(accounts)
    ...
    override fun getAll(): Flow<List<AccountsEntity>> = db.accountsDao().fetchAccounts()
