package com.devamsba.managebudget.feat_categries.presentation.dialog
...
import com.devamsba.managebudget.feat_categries.presentation.CategoryViewModel
...
@AndroidEntryPoint
class CreateNewCategoryDialog constructor(
    ...
    val viewModel:
            CategoryViewModel by viewModels()
    ...
    private fun storeDataToLocalDb() {
        ...
        val type = CategoriesEntity(name = typeOfEditText, type = "Expenses")
    ...
    private fun initCategoryList() {
        ...
        val listOfCategories =
            arrayListOf(
                CategoriesEntity(name = "Gifts", type = "Expenses"),
                CategoriesEntity(name = "Health", type = "Expenses"),
                CategoriesEntity(name = "Transport", type = "Expenses"),
                CategoriesEntity(name = "House", type = "Expenses"),
                CategoriesEntity(name = "Pets", type = "Expenses"),
                CategoriesEntity(name = "Sports", type = "Expenses"),
                CategoriesEntity(name = "Taxi", type = "Expenses"),
                CategoriesEntity(name = "Toiletry", type = "Expenses"),
                CategoriesEntity(name = "Bills", type = "Expenses"),
                CategoriesEntity(name = "Clothes", type = "Expenses"),
                CategoriesEntity(name = "Eating out", type = "Expenses"),
                CategoriesEntity(name = "Toiletry", type = "Expenses"),
                CategoriesEntity(name = "Food", type = "Expenses"),
                CategoriesEntity(name = "Deposits", type = "Incomes"),
                CategoriesEntity(name = "Salary", type = "Incomes"),
                CategoriesEntity(name = "Saving", type = "Incomes"),
            )

        viewModel.insertAllCategory(listOfCategories)
        //  (activity as BaseActivity<*, *>).hideSoftInput()
